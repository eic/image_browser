...
// To run: root -b -l -q jetBenchmarks.C'("path/to/files",true)' Second argument prints histograms

void jetBenchmarks(TString infile="root://dtn-eic.jlab.org//work/eic2/EPIC/RECO/24.05.0/epic_craterlake/DIS/NC/18x275/minQ2=10/pythia8NCDIS_18x275_minQ2=10_beamEffects_xAngle=-0.025_hiDiv_5.2501.eicrecon.tree.edm4eic.root", bool PRINT=false, TString outputDir="")
{
  // Input
...
legend1->Draw();
  ...
  gPad->SetLogy();
  if(PRINT) c1->Print(outputDir+"numberRecoJets.png"); // Number of reconstructed jets per event with energy > 5 GeV and Abs(eta) < 2.5
   delete c1;
...
legend2->Draw();
  ...
  gPad->SetLogy();
  if(PRINT) c2->Print(outputDir+"recoJetEnergy.png"); // Energy spectrum of reconstructed jets with Abs(eta) < 2.5
...
legend3->Draw();
  ...
  gPad->SetLogy();
  if(PRINT) c3->Print(outputDir+"recoJetEta.png"); // Eta spectrum of reconstructed jets with energy > 5 GeV
    delete c3;
  // Reco E Vs Eta
  ...
  gPad->SetLogz();
  if(PRINT) c4->Print(outputDir+"recoJetEnergyvsEta.png"); // Energy vs eta of reconstructed jets
  ...
  gPad->SetLogz();
  if(PRINT) c5->Print(outputDir+"recoJetPhivsEta.png"); // Phi vs eta of reconstructed jets
...
legend6->Draw();
  ...
  gPad->SetLogy();
  if(PRINT) c6->Print(outputDir+"numConstituentsPerRecoJet.png"); // Number of constituents in reconstructed jets
  ...
  gPad->SetLogy();
  if(PRINT) c7->Print(outputDir+"recoJetConstituentEnergy.png"); // Energy of reconstructed jet constituents
  ...
  gPad->SetLogy();
  if(PRINT) c8->Print(outputDir+"recoJetConstituentEta.png"); // Eta of reconstructed jet constituents
  ...
  gPad->SetLogz();
  if(PRINT) c9->Print(outputDir+"recoJetConstituentEnergyVsEta.png"); // Energy vs eta of reconstructed jet constituents
  ...
  gPad->SetLogz();
  if(PRINT) c10->Print(outputDir+"recoJetConstituentPhiVsEta.png"); // Phi vs eta of reconstructed jet constituents
  ...
  gPad->SetLogy();
  if(PRINT) c11->Print(outputDir+"recoJetConstituentPairwiseDR.png"); // Distance between each pair of constituents in reconstructed jets
  ...
  gPad->SetLogz();
  if(PRINT) c12->Print(outputDir+"recoJetEnergyVsEtaNoElectron.png"); // Reconstructed jet energy - no jets containing electrons included
  ...
  gPad->SetLogz();
  if(PRINT) c13->Print(outputDir+"recoJetPhiVsEtaNoElectron.png"); // Reconstructed Jet phi vs eta - no jets containing electrons included
  ...
  gPad->SetLogz();
  if(PRINT) c14->Print(outputDir+"recoJetConstituentEnergyVsEtaNoElectron.png"); // Reconstructed jet constituent energy vs eta - no jets containing electrons included
  ...
  gPad->SetLogz();
  if(PRINT) c15->Print(outputDir+"recoJetConstituentPhiVsEtaNoElectron.png"); // Reconstructed jet constituent phi vs eta - no jets containing electrons included
  ...
  gPad->SetLogy();
  if(PRINT) c16->Print(outputDir+"numberGenJets.png"); // Number of generator jets per event with energy > 5 GeV and Abs(eta) < 2.5
  ...
  gPad->SetLogy();
  if(PRINT) c17->Print(outputDir+"genJetEnergy.png"); // Energy spectrum of generated jets with Abs(eta) < 2.5
  ...
  gPad->SetLogy();
  if(PRINT) c18->Print(outputDir+"genJetEta.png"); // Eta spectrum of generator jets with energy > 5 GeV
  ...
  gPad->SetLogz();
  if(PRINT) c19->Print(outputDir+"genJetEnergyvsEta.png"); // Energy vs eta of generator jets
  ...
  gPad->SetLogz();
  if(PRINT) c20->Print(outputDir+"genJetPhiVsEta.png"); // Phi vs eta of generator jets
  ...
  legend21->Draw();
  gPad->SetLogy();
  if(PRINT) c21->Print(outputDir+"numConstituentsPerGenJet.png"); // Number of constituents in generator jets
  ...
  gPad->SetLogy();
  if(PRINT) c22->Print(outputDir+"genJetConstituentEnergy.png"); // Energy of generator jet constituents
  ...
  gPad->SetLogy();
  if(PRINT) c23->Print(outputDir+"genJetConstituentEta.png"); // Eta of generator jet constituents
  ...
  gPad->SetLogz();
  if(PRINT) c24->Print(outputDir+"genJetConstituentEnergyVsEta.png"); // Energy vs eta of generator jet constituents
  ...
  gPad->SetLogz();
  if(PRINT) c25->Print(outputDir+"genJetConstituentPhiVsEta.png"); // Phi vs eta of generator jet constituents
  ...
  gPad->SetLogy();
  if(PRINT) c26->Print(outputDir+"genJetConstituentPairwiseDR.png"); // Distance between each pair of constituents in generator jets
  ...
  gPad->SetLogz();
  if(PRINT) c27->Print(outputDir+"genJetEnergyVsEtaNoElectron.png"); // Generator jet energy vs eta - no jets containing electrons included
  ...
  gPad->SetLogz();
  if(PRINT) c28->Print(outputDir+"genJetPhiVsEtaNoElectron.png"); // Generator Jet phi vs eta - no jets containing electrons included
  ...
  gPad->SetLogz();
  if(PRINT) c29->Print(outputDir+"genJetConstituentEnergyVsEtaNoElectron.png"); // Generator jet constituent energy vs eta - no jets containing electrons included
  ...
  gPad->SetLogz();
  //c30->Print(outputDir+"recoJetEvsEta.png");
  if(PRINT) c30->Print(outputDir+"genJetConstituentPhiVsEtaNoElectron.png"); // Generator jet constituent phi vs eta - no jets containing electrons included
  ...
  gPad->SetLogy();
  if(PRINT) c31->Print(outputDir+"genRecoJetDeltaR.png"); // Distance between closest generated and reconstructed jet pair
  ...
  gPad->SetLogz();
  if(PRINT) c32->Print(outputDir+"matchedRecoVsGenJetEta.png"); // Matched Reconstructed Vs Generator Jet eta
  ...
  gPad->SetLogz();
  if(PRINT) c33->Print(outputDir+"matchedRecoVsGenJetPhi.png"); // Matched reconstructed vs generator jet phi
  ...
  f3_34->Draw("SAME");
  gPad->SetLogz();
  if(PRINT) c34->Print(outputDir+"matchedRecoVsGenJetEnergy.png"); // Matched reconstructed vs generator jet energy
  ...
  gPad->SetLogz();
  if(PRINT) c35->Print(outputDir+"matchedJetResolutionVsEta.png"); // Matched jet resolution vs generator jet eta
  ...
  gPad->SetLogz();
  if(PRINT) c36->Print(outputDir+"matchedJetResolutionVsEnergy.png"); // Matched jet resolution vs generator jet energy
  ...
  gPad->SetLogz();
  if(PRINT) c37->Print(outputDir+"matchedJetResolutionVsEnergyNegEta.png"); // Matched jet resolution vs generator jet energy -2.5 < eta < -1.0
  ...
  gPad->SetLogz();
  if(PRINT) c38->Print(outputDir+"matchedJetResolutionVsEnergyMidEta.png"); // Matched jet resolution vs generator jet energy -1.0 < eta < 1.0
    delete c38;
  ...
  gPad->SetLogz();
  if(PRINT) c39->Print(outputDir+"matchedJetResolutionVsEnergyPosEta.png"); // Matched jet resolution vs generator jet energy 1.0 < eta < 2.5
  delete c39;
  ...
  if(PRINT) c40->Print(outputDir+"matchedJetResolutionVsEnergyNegEtaFitSummary.png"); // Matched jet resolution vs generator jet energy -2.5 < eta < -1.0 fits
    delete c40;
  ...
  if(PRINT) c41->Print(outputDir+"matchedJetResolutionVsEnergyMidEtaFitSummary.png"); // Matched jet resolution vs generator jet energy -1.0 < eta < 1.0 fits
    delete c41;
  ...
  if(PRINT) c42->Print(outputDir+"matchedJetResolutionVsEnergyPosEtaFitSummary.png"); // Matched jet resolution vs generator jet energy 1.0 < eta < 2.5 fits
    delete c42;
...
legend->Draw();
  ...
  if(PRINT) c43->Print(outputDir+"matchedJetScaleResolutionSummary.png"); // Matched jet JER/JES summary
    delete c43;
